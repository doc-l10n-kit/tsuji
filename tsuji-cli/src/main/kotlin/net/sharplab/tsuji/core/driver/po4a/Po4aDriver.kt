...
interface Po4aDriver {
    ...
    fun updatePo(masterFile: Path, poFile: Path, format: String, workingDirectory: Path)
    fun translate(masterFile: Path, poFile: Path, localizedFile: Path, format: String, workingDirectory: Path)
}
